...
export default function About(props) {
    ...
    const [myStyle,stateState] = useState(
        {
        color: 'black',
  ...
  return (
    ...
    <div className="container" style={{backgroundColor:(props.mode==="light"?"white":"#042743"),color:(props.mode==="light"?"black":"white")}}>
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <div id="collapseOne" style={{backgroundColor:(props.mode==="light"?"white":"#042743"),color:(props.mode==="light"?"black":"white")}} className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        ...
        <button className="btn btn-primary my-4" onClick={darkModeEnable}>{btnText}</button>
</div>
  )
}
