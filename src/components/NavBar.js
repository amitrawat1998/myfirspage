...
export default function NavBar(props) {
  return (
    // <nav className="navbar navbar-expand-lg" style={{backgroundColor:(props.color.bgcolor),color:(props.color.color)}}>
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className={`form-check form-switch text-${props.mode==='light'?"dark":"light"}`}>
          <input className="form-check-input" onClick={props.colorChangeGree} type="checkbox" role="switch" id="flexSwitchCheckDefault" />
